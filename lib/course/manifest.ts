...
export const componentManifest: Record<ComponentTypeName, ComponentManifestEntry> = {
  ...
  module: {
    ...
    allowedActions: ["ADD_LESSON", "REORDER_MODULE", "REORDER_LESSON", "UPDATE_TEXT"],
  ...
  lesson: {
    ...
    allowedActions: ["ADD_BLOCK", "REORDER_LESSON", "REORDER_BLOCK", "UPDATE_TEXT"],
  ...
  slide: {
    ...
    allowedChildren: ["slide_element", "image_element", "callout_element"],
    allowedActions: [
      "ADD_SLIDE_ELEMENT",
  ...
  quiz: {
    ...
    semanticTags: ["assessment", "auto-gradable"],
  },
  quiz_question: {
    description:
