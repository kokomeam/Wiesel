...
/**
 * Student-portal error boundary (/home, /my-courses, /explore). Renders
 * inside the student shell (sidebar stays up). Friendly recovery card; the
 * raw message stays behind a <details> for debugging.
 */
    ...
    <div className="mx-auto flex min-h-[60vh] w-full max-w-lg flex-col items-center justify-center px-6 py-16">
      <div className="w-full rounded-2xl border border-stone-200/80 bg-white p-8 text-center shadow-[0_1px_2px_rgba(68,48,28,0.05)]">
        ...
        <p className="mt-3 text-sm leading-relaxed text-stone-500">
          This page hit a snag while loading. Your learning progress is safe —
          trying again usually clears it.
        </p>
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
          <Button onClick={reset} variant="learn">
            Try again
          </Button>
          <Link
            href="/home"
