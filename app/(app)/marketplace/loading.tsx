...
/**
 * Marketplace loading skeleton — mirrors the real page geometry (PageHeader,
 * mono section eyebrow, the 3-col grid of ListingCards with their
 * aspect-[16/9] cover media) so the swap to real content doesn't shift.
 */
...
export default function MarketplaceLoading() {
  return (
    <div className="mx-auto max-w-7xl space-y-10 p-6 lg:p-8">
      ...
      {/* Browse section: mono eyebrow + card grid */}
      <section aria-hidden>
