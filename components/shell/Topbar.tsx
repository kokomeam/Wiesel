...
export function Topbar() {
  return (
    <header className="sticky top-0 z-20 flex h-16 items-center gap-3 border-b border-stone-200 bg-white/80 px-4 backdrop-blur sm:gap-4 sm:px-6">
      <MobileNav />
      {/* Search */}
      <div className="relative w-full max-w-md">
        ...
        <input
          ...
          className="h-9 w-full rounded-full border border-stone-200 bg-stone-50 pl-9 pr-16 text-sm text-stone-700 placeholder:text-stone-500 focus:border-brand-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-brand-500/15"
        />
        <kbd className="pointer-events-none absolute right-2.5 top-1/2 -translate-y-1/2 rounded border border-stone-200 bg-white px-1.5 py-0.5 text-meta font-medium text-stone-500">
          ⌘K
        </kbd>
      </div>
