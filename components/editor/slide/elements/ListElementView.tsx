...
import type { SlideListContent, SlideListItem } from "@/lib/course/types";
import { ListContent, ListDisplay, rowStyles, type ListEl, type RowStyle } from "./ListView";
import { plainTextToHtml, runsToHtml, serializeRuns, setActiveRichEditor } from "./richText";

/* The pure display half lives in ListView.tsx (shared with the read-only
